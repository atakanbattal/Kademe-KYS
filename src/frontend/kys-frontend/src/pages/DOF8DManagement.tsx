...
const ROOT_CAUSE_CATEGORIES = [
  {
    ...
    causes: [
      ...
      'Süreç bilgisi eksikliği',
      'Sorumluluk bilinci eksikliği'
    ],
    keywords: ['operatör', 'eğitim', 'personel', 'insan', 'yetkinlik', 'dikkat', 'yorgunluk', 'motivasyon', 'iletişim', 'oryantasyon']
  },
  {
    ...
    causes: [
      ...
      'Eskimiş ekipman',
      'Yazılım hatası',
      'Elektrik sistem problemi'
    ],
    keywords: ['makine', 'ekipman', 'arıza', 'kalibrasyon', 'bakım', 'sensör', 'yedek', 'aşınma', 'ayar', 'yazılım', 'elektrik']
  },
  {
    ...
    causes: [
      ...
      'Hammadde spesifikasyon sapması',
      'Depolama koşulları',
      'Taşıma hasarı',
      'Son kullanma tarihi',
      'Lot değişkenliği',
      ...
      'Malzeme kirliliği',
      'Ambalaj sorunu',
      'İnceleme/test eksikliği'
    ],
    keywords: ['tedarikçi', 'malzeme', 'hammadde', 'spesifikasyon', 'depolama', 'taşıma', 'lot', 'karışım', 'kirlilik', 'ambalaj', 'test']
  },
  {
    ...
    icon: 'YP',
    causes: [
      'Prosedür güncel değil',
      'İş talimatı eksik',
      'Standart olmayan yöntem',
      'Kontrol noktası eksikliği',
      'Doğrulama yetersizliği',
      'Risk değerlendirmesi eksik',
      'Süreç akışı belirsiz',
      'Kriterler net değil',
      'Dökümentasyon eksik',
      'Onay süreçi yetersiz'
    ],
    keywords: ['prosedür', 'talimat', 'standart', 'yöntem', 'kontrol', 'doğrulama', 'risk', 'süreç', 'kriter', 'döküman', 'onay']
  },
  {
    ...
    keywords: ['çevre', 'sıcaklık', 'nem', 'titreşim', 'aydınlatma', 'gürültü', 'temizlik', 'hava', 'ergonomi', 'alan']
  },
  {
    ...
    icon: 'ST',
    causes: [
      'Yazılım güncellemesi etkisi',
      'Sistem entegrasyon hatası',
      'Veri kaybı',
    ...
    keywords: ['yazılım', 'sistem', 'entegrasyon', 'veri', 'ağ', 'güvenlik', 'yedek', 'performans', 'uyumluluk', 'database', 'konfigürasyon']
  },
  {
    ...
    causes: [
      ...
      'Planlama hatası',
      'Müşteri gereksinim değişikliği',
      'Bütçe kısıtları',
